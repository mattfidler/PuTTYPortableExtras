...
tray and upxed it as well.  I have made [[http://code.google.com/p/putty-portable-extras/downloads/detail?name=PuttyPortableExtrasInstaller-0.62-1.exe&can=2&q=][an installer]].
* How this works
